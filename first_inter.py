...
df1 = pd.read_csv("intervention_1.csv")

population1 = df1["Math_score"].tolist()

intervention1_mean = stats.mean(population1)

fig.add_trace(go.Scatter(x = [intervention1_mean, intervention1_mean], y = [0, 0.3], mode = "lines", name = "Intervention 1 Average"))

fig.show()

z_score = (intervention1_mean - sampling_mean) / sampling_stdev
