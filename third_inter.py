...
df3 = pd.read_csv("intervention_3.csv")

population3 = df3["Math_score"].tolist()

intervention3_mean = stats.mean(population3)

fig.add_trace(go.Scatter(x = [intervention3_mean, intervention3_mean], y = [0, 0.3], mode = "lines", name = "Intervention 3 Average"))

fig.show()

z_score = (intervention3_mean - sampling_mean) / sampling_stdev
